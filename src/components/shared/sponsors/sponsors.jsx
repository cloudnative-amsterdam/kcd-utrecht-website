  ...
  <section className="safe-paddings relative bg-white py-16 sm:py-16">
    <div className="container text-center">
      ...
      <p className="mx-auto mt-6 max-w-[800px] text-lg leading-normal text-primary-1">
        ...
        to explore how you can make a lasting impact on the future of cloud-native computing. Please see our <a href="https://drive.google.com/file/d/1iXJpCmh2v_a0PviqjXg_H3NbBkv060q2/view?usp=sharing"><em><i><u>sponsorship prospectus</u></i></em></a> for more information.
      </p>
